 ...
 * @Date 2026/4/13
 */
public class ParrelStreamClickhouseTest {
    private static Logger logger = LoggerFactory.getLogger(ParrelStreamClickhouseTest.class);
...
//        multiagentIntroduceProvinces("kimi","介绍省份智能体","kimi-k2.6",null);
        ...
        multiagentIntroduceProvinces("qwenvlplus","介绍省份智能体","qwen3.7-plus","c68e829d6abf4dbcb2d089682073e323");
    }
	public static void initDB(){
		...
		tempConf.setJdbcurl("jdbc:clickhouse:http://10.13.6.4:28123,10.13.6.7:28123,10.13.4.6:28123/visualops?b.enableBalance=true&b.balance=roundbin");
