 ...
 *
 * <p>Fires on {@link #compact}. When the compaction threshold is exceeded:
 * <ol>
 ...
 */
public class CompactionManager extends BaseCompactionManager {
...
//						});
     ...
     */
    private CompactionConfig resolveEffectiveConfig(ModelInfo modelInfo) {
