...
/**
 * Immutable allow-list of host directories that { LocalFsMode#ROOTED} accepts for absolute
...
public final class PathPolicy {
	...
	private static final PathPolicy EMPTY = new PathPolicy(Collections.emptyList());
	...
	public boolean equals(Object o) {
		PathPolicy other = null;
		if(o instanceof PathPolicy) {
			other = (PathPolicy) o;
			return Objects.equals(roots, other.roots);
		}
		return false;
	}
