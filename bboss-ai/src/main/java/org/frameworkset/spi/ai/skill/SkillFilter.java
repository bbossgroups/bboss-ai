...
public class SkillFilter {
    ...
    public static SkillFilter only(String... skillNames) {
        return new SkillFilter(Mode.WHITELIST, setOf(skillNames));
    }
	
	private static Set<String> setOf(String... skillNames) {
    ...
    public static SkillFilter except(String... skillNames) {
        return new SkillFilter(Mode.BLACKLIST, setOf(skillNames));
    }
    ...
    public static SkillFilter enable(String... skillNames) {
        return new SkillFilter(Mode.OVERLAY_ENABLE, setOf(skillNames));
    }

    /** Overlay: explicitly disable these skills (others unchanged). */
    public static SkillFilter disable(String... skillNames) {
        return new SkillFilter(Mode.OVERLAY_DISABLE, setOf(skillNames));
    }
    ...
    public boolean isAllowed(String skillName) {
        switch (mode) {
            ...
            case WHITELIST : return skillNames.contains(skillName);
            case BLACKLIST : return !skillNames.contains(skillName);
            case OVERLAY_ENABLE : return skillNames.contains(skillName);
            case OVERLAY_DISABLE : return !skillNames.contains(skillName);
        };
		return false;
    }
