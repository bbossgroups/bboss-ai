 ...
 * @Date 2026/8/28
 */
public class HttpWebToolTest {
	static org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(HttpWebToolTest.class);
	public static void main(String[] args) {
		String search = "Who is Leo Messi?";
		search = "查询bboss-ai的文档网站和源码地址，找到地址后获取对应网页中的文档内容。";
...
//		String question = "检索包含关键字多轮会话的文件";
		chatAgentMessage.setPrompt(search).setSystemPrompt("你是一个web检索专家，可以根据用户要求，调用工具web_search从互联网检索包含用户要求关键字的文件内容；" +
